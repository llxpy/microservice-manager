...
export const rest = {
  ...
  update: (id, body) => api('PUT', `/api/services/${encodeURIComponent(id)}`, body),
  create: (body) => api('POST', '/api/services', body),
  openDir: (id) => api('POST', `/api/services/${encodeURIComponent(id)}/open-dir`),
