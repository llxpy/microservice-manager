...
| 🗂 **Tray resident** | No black window. Tray icon opens the panel, graceful exit |
...
<details>
<summary><b>Tray & logs</b></summary>

- Tray menu: **Open panel** / **Exit** (exiting does not affect running service processes)
- Panel runtime log: `logs/manager.log`
- Startup errors (e.g. port already in use) appear as a system dialog
